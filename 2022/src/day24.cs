...
namespace AdventOfCode2022.Day24
{
    ...
    {
        private static readonly Vec2[] nDirs = new Vec2[] { new Vec2(-1, 0), new Vec2(1, 0), new Vec2(0, -1), new Vec2(0, 1), new Vec2(0, 0) };

        private static readonly (Cell, Vec2)[] dirVecs = new (Cell, Vec2)[]
        {
            (Cell.Left, nDirs[0]),
            (Cell.Right, nDirs[1]),
            (Cell.Up, nDirs[2]),
        ...
        private static int FindPath(Map map, Vec2 from, Vec2 to, int startTime)
        {
        ...
        private static Map ParseMap(string[] lines, out Vec2 start, out Vec2 end)
        {
        ...
        private class Map
        {
            private readonly Cell[][,] maps;

            public int Width { get; init; }
            public int Height { get; init; }
            public int Duration { get; init; }

            public Cell this[int t, Vec2 pos] => maps[t % maps.Length][pos.y, pos.x];
            ...
            private static Cell[,] Simulate(Cell[,] source)
            {
