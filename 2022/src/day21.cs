    ...
    public class Solution : SolutionBase
    {
        ...
        public override object? SolveSecond()
        {
            ...
            while(lastDiff != 0)
            {
                ...
                //This is required, because the calculations to "inc" are casted to long which results in values that could be slighty off
        ...
        private static (long l, long r) Solve(Monkey[] monkeys, long input)
        {
            foreach(Monkey monkey in monkeys)
            {
                monkey.ResetResult();
