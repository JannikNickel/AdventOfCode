...
namespace AdventOfCode2022.Day20
{
    public class Solution : SolutionBase
    {
        ...
        private static long[] ParseNumbers(string[] lines)
        {
        ...
        {
            private readonly RingItem<T>[] items;

            public T this[long index] => items[index % items.Length].Value;
            ...
            {
                (items[nIndex], items[index]) = (items[index], items[nIndex]);
                items[nIndex].Index = nIndex;
