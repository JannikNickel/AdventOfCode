...
namespace AdventOfCode2022.Day19
{
    public class Solution : SolutionBase
    {
        ...
        private static int FindBestBpOutcome(Blueprint bp, int time)
        {
        ...
        private static Blueprint[] ParseBlueprints(string[] lines)
        {
        ...
        {
            public readonly Inventory SimulateMinute() => new Inventory(oreRobots, clayRobots, obsidianRobots, geodeRobots, ore + oreRobots, clay + clayRobots, obsidian + obsidianRobots, geodes + geodeRobots);
        }
        ...
        {
            public bool CanBeUsed(in Inventory inv) => ore <= inv.ore && clay <= inv.clay && obsidian <= inv.obsidian;

            public Inventory UseItems(Inventory inventory) => inventory with { ore = inventory.ore - ore, clay = inventory.clay - clay, obsidian = inventory.obsidian - obsidian };
        }
    }
}
