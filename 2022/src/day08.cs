...
namespace AdventOfCode2022.Day08
{
    public class Solution : SolutionBase
    {
        ...
        private static void CalcVisibility(int[,] trees, int[,] visibility, int gridSize, (int x, int y) dir)
        {
            int i = 0;
            int k = 0;
        ...
        private static int CalcScenicScore(int[,] trees, int gridSize, int i, int k)
        {
        ...
        private static int[,] ParseTreeHeights(string[] lines, out int gridSize)
        {
