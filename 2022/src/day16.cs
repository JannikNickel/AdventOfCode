...
namespace AdventOfCode2022.Day16
{
    public class Solution : SolutionBase
    {
        ...
        private static int FindHighestPressure(Valve start, BitMask initalUsed, int time)
        {
            int max = 0;
        ...
        private static (Valve root, Valve[] valves) ParseInput(string[] lines)
        {
        ...
        private static IEnumerable<IEnumerable<IEnumerable<T>>> Partitions<T>(T[] source, int splits)
        {
        ...
        public struct BitMask
        {
            ...
            public static implicit operator long(BitMask mask) => mask.data;
        }
