...
namespace AdventOfCode2022.Day18
{
    ...
    {
        private static readonly Vec3[] dirs = new Vec3[6]
        {
            new Vec3(1, 0, 0),
            new Vec3(-1, 0, 0),
            new Vec3(0, 1, 0),
        ...
        private static byte[,,] Gen3DMap(Vec3[] cubes)
        {
        ...
        private static int CalcSurfaceArea(byte[,,] map)
        {
        ...
        private static Vec3[] ParseCubes(string[] lines)
        {
