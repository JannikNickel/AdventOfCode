...
namespace AdventOfCode2022.Day23
{
    ...
    {
        private static readonly Vec2[][] directions = new Vec2[][]
        {
        ...
        private static readonly Vec2[] allDirs = new Vec2[]
        {
        ...
        private static int Simulate(Elf[] elves, int roundLimit, out int rounds)
        {
        ...
        private static int FreeArea(Dictionary<Vec2, Elf> positions)
        {
        ...
        private static Elf[] ParseElves(string[] lines)
        {
