...
namespace AdventOfCode2022.Day17
{
    public class Solution : SolutionBase
    {
        ...
        private static int[] ParseDirections(string input)
        {
        ...
        private class ExpandingGrid
        {
            ...
            private readonly List<BitMask> rows = new List<BitMask>();
            ...
            {
                pos.x += dir;
                return pos.x < 0 || pos.x + shape.Width > width || ShapeOverlapping(shape, pos);
            }

            private bool BottomBlocked(Shape shape, Vec2 pos)
            {
                pos.y--;
                return pos.y < 0 || ShapeOverlapping(shape, pos);
            }
        ...
        public struct BitMask
        {
            ...
            public static implicit operator int(BitMask mask) => mask.data;
        }
    }
}
