...
namespace AdventOfCode2022.Day12
{
    ...
    {
        private static readonly Vec2[] neighbourOffsets = new Vec2[]
        {
        ...
        private static int BFS(char[,] map, Vec2 start, Vec2? target = null)
        {
        ...
        private static char[,] ParseMap(string[] lines, out Vec2 start, out Vec2 target)
        {
            start = default;
            target = default;
