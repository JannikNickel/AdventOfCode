...
namespace AdventOfCode2022.Day14
{
    ...
    {
        private static readonly Vec2[] fallOffsets = new Vec2[3]
        {
        ...
        private static bool SimulateSand(byte[,] cave, Vec2 origin)
        {
            Vec2 pos = origin;
        ...
        private static byte[,] ParseCave(string[] lines, out int maxY)
        {
            maxY = 0;
        ...
        private static void RenderLine(byte[,] data, Vec2 from, Vec2 to)
        {
